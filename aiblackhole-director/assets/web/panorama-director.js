...
const translations = {
  zh: {
    pageTitle: "720° 全景导演台 v1.2",
    canvasLabel: "720 全景导演台画面",
    emptyTitle: "全景导演台",
    emptyDescription: "先上传一张 720°/等距柱状全景图，然后添加角色、物体、遮挡物和机位构图。v1.2 支持批量选择、整体变换、骨骼可视化和撤销/重做。",
    emptyUpload: "上传全景图片",
    ...
    leftShoulder: "左上臂°",
    rightShoulder: "右上臂°",
    leftShoulderTwist: "左上臂内外旋°",
    rightShoulderTwist: "右上臂内外旋°",
  ...
  en: {
    pageTitle: "720° Panorama Director v1.2",
    canvasLabel: "720 panorama director canvas",
    emptyTitle: "Panorama Director",
    emptyDescription: "Upload a 720°/equirectangular panorama, then add characters, objects, occluders, and camera blocking. v1.2 supports multi-select, group transforms, skeleton visualization, and undo/redo.",
    ...
    leftPalmTwist: "Left Palm Twist °",
    rightPalmTwist: "Right Palm Twist °",
    ...
    leftFootPitch: "Left Foot Pitch °",
    rightFootPitch: "Right Foot Pitch °",
